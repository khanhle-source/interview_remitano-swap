...
public class Your_Price {
    ...
    @Test
    public void Swap002_Your_Price_Without_Login() {
        System.out.println("Swap Page - Step 01: Close Popup");
        swapPage.closePopup();

        System.out.println("Swap Page - Step 02: Click to Your Price option");
        swapPage.clickToYourPriceRadioButton();

        System.out.println("Swap Page - Step 03: Input Source Amount ");
        swapPage.inputToSourceAmountTextbox("1");

        System.out.println("Swap Page - Step 04: Input Price ");
        swapPage.inputPrice("20000");

        Assert.assertEquals(swapPage.getAmountofUSDT(), "19,950");

        System.out.println("Swap Page - Step 06: Click Submit swap button");
    ...
    @Test
    public void Swap002_Your_Price_Source_Amount_Equal_0() {
        System.out.println("Swap Page - Step 01: Close Popup");
        swapPage.closePopup();
    ...
    @Test
    public void Swap002_Your_Price_View_Chart() {
        System.out.println("Swap Page - Step 01: Close Popup");
        swapPage.closePopup();
